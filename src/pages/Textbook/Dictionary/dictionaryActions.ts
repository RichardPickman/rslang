...
//   words: DisplayedWord[];
//   constructor(setIsProcessing: Dispatch<SetStateAction<boolean>>, dictWords: DisplayedWord[]) {
//     this.setIsProcessing = setIsProcessing;
//     this.words = dictWords;
//   }
//   addToDifficultWords = ({ id, word, user }: addProps) => {
...
//       })
//       .finally(() => {
//         this.setIsProcessing((prev) => !prev)
//       });
//   }

//   removeFromDifficultWords = ({ id, word, user, words, setIsProcessing, setDictWords, setSelectedWord }: removeProps) => {
...
//   addToLearnedWords = ({ id, word, user, words, setIsProcessing }: addProps) => {
...
//   removeFromLearnedWords = ({ id, word, user, words, setIsProcessing, setDictWords, setSelectedWord }: removeProps) => {
